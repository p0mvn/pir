...
const PirClientFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_pirclient_free(ptr >>> 0, 1));
...
export class PirClient {
     ...
     */
    num_records() {
        const ret = wasm.pirclient_num_records(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    record_size() {
        const ret = wasm.pirclient_record_size(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @param {Uint8Array} rec2
     * @returns {Uint8Array}
     */
    decode_keyword(rec0, rec1, rec2) {
        const ptr0 = passArray8ToWasm0(rec0, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(rec1, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(rec2, wasm.__wbindgen_malloc);
     ...
     * @returns {Uint8Array}
     */
    recover(state_json, answer_json) {
...
if (Symbol.dispose) PirClient.prototype[Symbol.dispose] = PirClient.prototype.free;
